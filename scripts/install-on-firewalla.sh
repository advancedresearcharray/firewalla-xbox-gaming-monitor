...
install -m 755 "$REMOTE_SRC/gaming-buffer-tune.sh" "$TOOLS_DIR/gaming-buffer-tune.sh"
...
install -m 755 "$REMOTE_SRC/gaming-offload-audit.sh" "$TOOLS_DIR/gaming-offload-audit.sh"
